...
export const EditorCodeLineNumbers: React.FC<
  EditorCodeLineNumbersProps
> = ({}) => {
   ...
   */
  const handleCodeLineNumbersChange = (
  ...
  return (
    <HStack pb={2} justifyContent='space-between' width='full'>
      ...
      <Switch
        onChange={handleCodeLineNumbersChange}
        isChecked={codeCustomization.lineNumbers}
      />
    </HStack>
  );
};
