...
interface EditorWindowControlsIconsProps {}

const EditorWindowControlsIcons: React.FC<EditorWindowControlsIconsProps> = ({}) => {
  return (
...
export default EditorWindowControlsIcons;
